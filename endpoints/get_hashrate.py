...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["BTM network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["BTM network info"])
@sql_db_only
