...
@app.get("/blocks/{blockId}", response_model=BlockModel, tags=["BTM blocks"])
...
@app.get("/blocks", response_model=BlockResponse, tags=["BTM blocks"])
...
@app.get("/blocks-from-bluescore", response_model=List[BlockModel], tags=["BTM blocks"])
